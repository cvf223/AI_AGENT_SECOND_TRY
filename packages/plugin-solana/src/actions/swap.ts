...
// Import Solana Web3.js & BigNumber
...
// If we get the token symbol but not the CA, check wallet for matching token, and if we have, get the CA for it
...
const NAME = "EXECUTE_SWAP";
const SIMILIES = ["SWAP_TOKENS", "TOKEN_SWAP", "TRADE_TOKENS", "EXCHANGE_TOKENS"];
const DESCRIPTION = "Perform a token swap.";
